...
const SAVE_MODE_ __attribute__((aligned(4))) saveMODE_table[] = {
    ...
    {"BS4J", 0x22},  // 1340 - Simple 2960 Tomodachi Series Vol. 4 - The Trump - Minna de Asoberu 12 Shurui no Trump
                     // Game(JP).zip
    ...
    {"FTUJ",
     0x11},  // 1622 - Famicom Mini Vol. 28 - Famicom Tantei Club Part II - Ushiro ni Tatsu Shoujo - Zen Kou Hen(JP).zip
    ...
    {"BDFP",
     0x00},  // 1824 - 2 Games in 1 - SpongeBob SquarePants - SuperSponge + Revenge of the Flying Dutchman(EU).zip
    {"BSZX", 0x00},  // 1825 - 2 Games in 1 - SpongeBob SquarePants - SuperSponge + SpongeBob SquarePants - Battle for
    ...
    {"BDFE",
     0x00},  // 1935 - 2 Games in 1 - SpongeBob SquarePants - SuperSponge + Revenge of the Flying Dutchman(US).zip
    ...
    {"BBJP", 0x00},  // 2082 - 2 Games in 1 - SpongeBob SquarePants - Battle for Bikini Bottom + Jimmy Neutron - Boy
                     // Genius(EU).zip
    ...
    {"BFVJ",
     0x22},  // 2286 - Twin Series 1 - Mezase Debut! Fashion Designer Monogatari + Kawaii Pet Game Gallery 2(JP).zip
    ...
    {"BT8P", 0x22},  // 2342 - 2 Games in 1 - Teenage Mutant Ninja Turtles + Teenage Mutant Ninja Turtles 2 - Battle
                     // Nexus(EU).zip
    ...
    {"B3NP",
     0x00},  // 2345 - 3 in 1 Sports Pack - Paintball Splat! + Dodgeball - Dodge This! + Big Alley Bowling(EU).zip
    ...
    {"B53E", 0x23},  // 2421 - 2 Games in 1 - Spyro Orange - The Cortex Conspiracy + Crash Bandicoot Purple - Ripto's
                     // Rampage(US).zip
    ...
    {"B44P", 0x22},  // 2434 - 3 Games in 1 - Rugrats - I Gotta Go Party + SpongeBob SquarePants - SuperSponge + Tak and
                     // the Power of Juju(EU).zip
    ...
    {"BT8E", 0x22},  // 2526 - 2 Games in 1 - Teenage Mutant Ninja Turtles + Teenage Mutant Ninja Turtles 2 - Battle
                     // Nexus(US).zip
    ...
    {"B3NE",
     0x00},  // 2553 - 3 in 1 Sports Pack - Paintball Splat! + Dodgeball - Dodge This! + Big Alley Bowling(US).zip
    ...
    {"BU2E", 0x22},  // 2570 - 2 Games in 1 - SpongeBob SquarePants - Battle for Bikini Bottom + Nicktoons - Freeze
                     // Frame Frenzy(US).zip
    ...
    {"B2BP", 0x22},  // 2624 - 2 Games in 1 - SpongeBob SquarePants - The Movie + SpongeBob SquarePants and Friends -
                     // Freeze Frame Frenzy(EU).zip
    ...
    {"BX6E", 0x00},  // 2632 - 2 Games in 1 - SpongeBob SquarePants - Battle for Bikini Bottom + Fairly Odd Parents!,
                     // The - Breakin' da Rules(US).zip
    ...
    {"B2EE", 0x00},  // 2660 - 2 Games in 1 - Dora the Explorer - The Search for the Pirate Pig's Treasure + Dora the
    ...
    {"BSZP", 0x00},  // 2682 - 2 Games in 1 - SpongeBob SquarePants - SuperSponge + SpongeBob SquarePants - Battle for
                     // Bikini Bottom(EU).zip
    ...
    {"BRSF", 0x00},  // 2721 - 2 Games in 1 - Les Razmoket Rencontrent les Delajungle + SpongeBob SquarePants -
                     // SuperSponge(FR).zip
    ...
    {"B54E", 0x22},  // 2784 - 2 Games in 1 - Crash & Spyro Super Pack - Spyro - Season of Ice + Crash Bandicoot - The
                     // Huge Adventure(US).zip
