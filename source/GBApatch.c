...
void IWRAM_CODE CheckNes(u32* Data) {
   ...
   if ((jump & 0xff000000) == 0xea000000) {
      ...
      if ((Data[Nes_index] & 0xffffff00) == 0xe28f5000 && Data[Nes_index + 1] == 0xe8b503d3 &&
          Data[Nes_index + 2] == 0xe129f007 && Data[Nes_index + 3] == 0xe281deba && Data[Nes_index + 4] == 0xe129f008 &&
          Data[Nes_index + 5] == 0xe281debe && Data[Nes_index + 6] == 0xe129f009 && Data[Nes_index + 7] == 0xe281dc0b &&
...
void Patch_Reset_Sleep(u32* Data) {
   ...
   *(vu32*)(patchbuffer + Return_address_offset) =
       Return_address;  // �޸�gba_sleep_patch_bin����ķ��ص�ַ
...
void Patch_SpecialROM_TrimSize(void) {
   switch (*(u32*)GAMECODE) {
      ...
      case 0x4A564642:  // 2286 - Twin Series 1 - Mezase Debut! Fashion Designer Monogatari + Kawaii Pet Game Gallery
                        // 2(JP)
